...
1. Abrir la carpeta `practica-2` dentro de parcial-1-poo en `htdocs` de XAMPP.
...
## Repositorio de githut 
https://github.com/JuanCarlos1213/desarrollo-web-avanzado-fimaz-uas/tree/main/parcial-1-poo/practica-2